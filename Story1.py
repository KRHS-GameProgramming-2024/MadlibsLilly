...
def Story1(debug = False):
    ...
    print (" ")
    place1 = getPlaceMenu("Pick a place from the following: ", debug)
    ...
    out += " where the duck lived and started making the fruit salad."
    out += ("\n") 
    out += "    They were almost done when they finished the cat realized that there was no " + fruitName2
    out += "."
